 ...
 *
 * Usage (from web):
 *   npx tsx scripts/db/print-invoice.ts [subscriptionId]
 *
 ...
 *
 * NOTE: standalone Node script — must use relative "../../src/..." imports, not an
 * alias (that only resolves through the Next bundler).
 */
import { prismaWithoutTenantScoping } from "../../src/lib/db/client";
import { resolveTaxRatePercent } from "../../src/lib/db/billing/tax";
