...
// of @/db gets it for free, same as this file already guarantees
...
export { resolveCheckoutProvider, NoPaymentProviderConfiguredError } from "./billing/checkout-provider";
...
// Notification-channel adapter framework (Â§2.14 / CLAUDE.md's provider-
