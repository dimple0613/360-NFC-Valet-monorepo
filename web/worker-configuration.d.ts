/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 9e2a6e300dd65e4be0e0dad413bd4463)
// Runtime types generated with workerd@1.20260908.1 2025-01-01 global_fetch_strictly_public,nodejs_compat,nodejs_compat_v2
interface __BaseEnv_CloudflareEnv {
	...
	WS_PORT: string;
	WS_ORIGIN: string;
	WS_BROADCAST_URL: string;
	NEXT_PUBLIC_WS_URL: string;
	NEXT_PUBLIC_GUEST_BASE: string;
	NEXT_PUBLIC_GUEST_SAMPLE_UID: string;
	DATABASE_URL: string;
	REDIS_URL: string;
	APP_URL: string;
	AUTH_SECRET: string;
	...
	CORS_ORIGINS: string;
	WORKER_SELF_REFERENCE: Fetcher /* 360-nfc-valet */;
}
